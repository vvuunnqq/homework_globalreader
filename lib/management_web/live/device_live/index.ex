defmodule ManagementWeb.DeviceLive.Index do
  ...
  defp apply_action(socket, :edit, %{"id" => id}) do
    ...
    |> assign(:device, DevicesAndJobs.get_device!(id))
  end
  ...
  def handle_event("delete", %{"id" => id}, socket) do
    device = DevicesAndJobs.get_device!(id)
    {:ok, _} = DevicesAndJobs.delete_device(device)

    {:noreply, assign(socket, :devices, list_devices())}
  end

  defp list_devices do
    DevicesAndJobs.list_devices()
  end
end
